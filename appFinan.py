...
# @st.cache_data
# def load_data():
#     # Ruta al archivo en Google Drive, asegúrate de poner la URL de tu archivo CSV
#     ruta = 'C:/Users/juan.ochoa/OneDrive - INMEL INGENIERIA SAS/Documentos/Python_Codigos/ITM Aplicación/consolidadoFinal.xlsx'
